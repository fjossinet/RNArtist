...
open class StringWithQuotes(parent:DSLElementInt, script: Script, value:String = "", editable: Boolean = false): ParameterField(parent, script, "\"${value}\"", editable) {
        ...
        if (editable) {
            this.text.onMouseClicked = EventHandler {
                ...
                textField.focusedProperty().addListener { observableValue, oldValue, newValue ->
                    if (!newValue) {
                        val parameterNode = textField.parent as DSLParameter.ParameterNode
    ...
    override fun clone(): StringWithQuotes = StringWithQuotes(this.parent, script, this.text.text.replace("\"", ""), this.editable)
