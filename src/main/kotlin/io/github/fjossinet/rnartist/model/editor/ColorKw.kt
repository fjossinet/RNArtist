...
class ColorKw(parent:ThemeKw, script: Script, indentLevel:Int): OptionalDSLKeyword(parent, script, "color", indentLevel) {
    ...
    init {
        ...
        this.children.add(DSLParameter(this, script, StringWithoutQuotes(this, script,"value"), Operator(this, script,"="), ColorField(this, script), this.indentLevel + 1))
        ...
        removeButton.mouseReleased = {
            ...
            else if (this.parent.children.indexOf(this) > 0 && this.parent.children.get(this.parent.children.indexOf(this) - 1) is ColorKw)
                this.parent.children.remove(this)
            script.initScript()
        }
    }
