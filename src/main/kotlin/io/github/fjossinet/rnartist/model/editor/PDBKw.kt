...
class PDBKw (val parent: SecondaryStructureInputKw?, script: Script, indentLevel:Int, inFinalScript:Boolean = false): OptionalDSLKeyword(script,  " pdb", indentLevel, inFinalScript) {
    ...
    override fun addToFinalScript(add:Boolean) {
        ...
        if (add) {
            ...
            this.children.add(1, OptionalDSLParameter(script, null, StringWithoutQuotes(script,"id"), Operator(script,"="), StringValueWithQuotes(script,"1EHZ", editable = true), this.indentLevel+1))
