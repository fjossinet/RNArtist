...
class PDBKw (val parent: SecondaryStructureInputKw, script: Script, indentLevel:Int): OptionalDSLKeyword(script,  " pdb", indentLevel) {
    ...
    init {
        ...
        this.children.add(1, OptionalDSLParameter(this, script, null, StringWithoutQuotes(script,"id"), Operator(script,"="), StringValueWithQuotes(script,"1EHZ", editable = true), this.indentLevel+1))
