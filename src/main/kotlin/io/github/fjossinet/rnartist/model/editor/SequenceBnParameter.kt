...
class SequenceBnParameter(script: Script, val bnValue: DSLParameter, indentLevel: Int, inFinalScript: Boolean = false, sequence:String = "click me to set your sequence") :
